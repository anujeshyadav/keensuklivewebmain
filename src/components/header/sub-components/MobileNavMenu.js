  ...
  return (
    <nav className="offcanvas-navigation" id="offcanvas-navigation">
      <ul>
        ...
        <li>
          <Link to="/pitraDosh">PitraDosh</Link>
        </li>
        <li>
          <Link to="/kalsharpDosh">KALSHARP DOSH</Link>
        </li>
        ...
        <li>
          ...
          <ul className="submenu">
            ...
            <li className="">
              <Link to={"/heroscopestwo1"}>
                {/* {strings["Weekly Horoscope"]} */}
                Weekly Horoscope
              </Link>
            </li>
            <li className="">
              <Link to={"/heroscopestwo2"}>
        ...
        <li className="">
          <Link to={"/astromallList"}>Astromall</Link>
        </li>
